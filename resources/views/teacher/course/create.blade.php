                ...
                <div class="col-sm-12 mx-auto">
                    <div class="bg-secondary rounded h-100 p-4">
                        ...
                        <form action="{{ route('courses.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" value=" {{Session::get('teacher_id')}}" name="teacher_id">
                            <div class="row mb-3">
                                <label for="title" class="col-sm-2 col-form-label">Course Title</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="course_title" id="title" placeholder="Enter Course Name">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="lectures" class="col-sm-2 col-form-label">Lectures</label>
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" name="lecture" id="lectures" placeholder="Enter Lectures Amount">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="duration" class="col-sm-2 col-form-label">Course Duration</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="course_duration" id="duration" placeholder="Enter Course Duration (Month)">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="shortDescription" class="col-sm-2 col-form-label">Short Description</label>
                                <div class="col-sm-10">
                                    <textarea name="short_description" class="form-control" id="shortDescription" cols="30" rows="2" placeholder="Enter Short Description"></textarea>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="longDescription" class="col-sm-2 col-form-label">Long Description</label>
                                <div class="col-sm-10">
                                    <textarea name="long_description" class="form-control" id="longDescription" cols="30" rows="5" placeholder="Enter Full Description"></textarea>
                                </div>
                            </div>
                            <fieldset class="row mb-3">
                                ...
                                <div class="col-md-9">
                                    <div class="form-check">
                                        <label for="beginner" class="pe-5"><input type="radio" class="form-check-input" id="beginner" name="course_level" value="1" checked/> Beginner</label>
                                        <label for="advance" class="pe-5"><input type="radio" class="form-check-input" id="advance" name="course_level" value="2"/> Advanced</label>
                                        <label for="expert"><input type="radio" class="form-check-input" id="expert" name="course_level" value="3"/> Expert</label>
                                    </div>
                                </div>
                            </fieldset>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" onkeyup="discountPrice();" name="course_fee" id="fee" placeholder="Enter Course Fee">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="discount" class="col-sm-2 col-form-label">Course Discount %</label>
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" onkeyup="discountPrice();" name="course_discount" id="discount" placeholder="Enter Course Discount in Percent %">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="discountedFee" class="col-sm-2 col-form-label">Course Discounted Fee</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control text-bg-dark" name="discounted_fee" id="total" placeholder="" readonly>
                                </div>
                            </div>
                            <div class="row mb-3">
